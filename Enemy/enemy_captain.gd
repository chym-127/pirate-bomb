...
func change_direction(direction):
	if direction > 0:
		sprite.flip_h = true
#		foot.position = Vector2(-6,32)
		hitBox.position = Vector2(13,0)
		hurtBox.position = Vector2(0,-3)
	if direction < 0:
#		foot.position = Vector2(5,33)
		hitBox.position = Vector2(-15,0)
		hurtBox.position = Vector2(9,0)
		sprite.flip_h = false
